...
RUN rm -rf $ci_subdir/app/Config/Security.php
RUN ln -s /var/www/localhost/htdocs/vendor/codeigniter4/framework/app/Config/Security.php $ci_subdir/app/Config
